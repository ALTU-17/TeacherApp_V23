...
public class NoticePojo implements Serializable {
   private String notice_id,subject,notice_desc,notice_date,start_date,end_date,class_id,section_id,notice_type,teacher_id,
    ...
    public NoticePojo(String notice_id, String subject, String notice_desc, String notice_date, String class_id, String notice_type, String teacher_id, String academic_yr, String publish, String name,String classname) {
...
/*
    public NoticePojo(String noticeId, String s, String notice_desc, String reqNoticedate, String class_id, String section_id, String notice_type, String teacher_id, String start_time, String end_time, String academic_yr) {
        this.notice_id = notice_id;
        this.subject = subject;
