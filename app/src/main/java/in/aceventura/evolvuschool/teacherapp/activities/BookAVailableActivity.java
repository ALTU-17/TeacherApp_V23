...
public class BookAVailableActivity extends AppCompatActivity implements View.OnClickListener{
private Button mBrowse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ht_Teachernote.setText("Book Availability");
            ...
            bottomBar.setOnTabSelectListener(new OnTabSelectListener() {
                ...
                public void onTabSelected(@IdRes int tabId) {
                    ...
                    if (tabId == R.id.tab_profile) {
                        Intent intent = new Intent(BookAVailableActivity.this, TeacherProfileActivity.class);
                        startActivity(intent);
                    }
                    if (tabId == R.id.tab_calendar) {
                        Intent intent = new Intent(BookAVailableActivity.this, MyCalendar.class);
                        startActivity(intent);
                    }
                }
            });
            bottomBar.setOnTabReselectListener(new OnTabReselectListener() {
                ...
                public void onTabReSelected(int tabId) {
                    ...
                    if (tabId == R.id.tab_dashboard) {
                        ...
                        Intent intent = new Intent(BookAVailableActivity.this, HomePageDrawerActivity.class);
                        startActivity(intent);
                    }
                }
            });
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnbrowse:
                Intent intent=new Intent(BookAVailableActivity.this,BookAvailListActivity.class);
                startActivity(intent);
                break;
        }
    }
