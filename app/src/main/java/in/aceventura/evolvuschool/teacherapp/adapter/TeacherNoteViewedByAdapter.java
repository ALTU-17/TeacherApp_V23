...
public class TeacherNoteViewedByAdapter extends RecyclerView.Adapter<TeacherNoteViewedByAdapter.DataHold> {
    private Context context;
    private ArrayList<ViewedByListPojo> viewedByArrayListPojo;

    public TeacherNoteViewedByAdapter(Context context, ArrayList<ViewedByListPojo> viewedByArrayListPojo) {
    ...
    public DataHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.teachernote_viewdby_item, parent, false);
