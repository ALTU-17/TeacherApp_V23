...
public class NoticeStaffPojo1 implements Serializable {
...
*/
    ...
    public NoticeStaffPojo1(String notice_id, String subject, String notice_desc, String reqNoticedate, String notice_type, String name) {
        this.notice_id = notice_id;
        this.subject = subject;
        this.name = name;
        this.notice_desc = notice_desc;
